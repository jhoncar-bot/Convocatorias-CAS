					...
					<tbody>
						<?php while($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
							<tr>
								...
								<td class="text-center"><p><small><b><?php echo $row['categoria1']; ?></b></small></p><a target="_black" href="<?php echo $row['nombre_archivo1']; ?>"><H4><?php echo $row['INFO1']; ?></H4></a></td>
								<td class="text-center"><p><small><b><?php echo $row['categoria2']; ?></b></small></p><a target="_black" href="<?php echo $row['nombre_archivo2']; ?>"><H4><?php echo $row['INFO2']; ?></H4></a></td>
								<td class="text-center"><p><small><b><?php echo $row['categoria3']; ?></b></small></p><a target="_black" href="<?php echo $row['nombre_archivo3']; ?>"><H4><?php echo $row['INFO3']; ?></H4></a></td>
								<td class="text-center"><p><small><b><?php echo $row['categoria4']; ?></b></small></p><a target="_black" href="<?php echo $row['nombre_archivo4']; ?>"><H4><?php echo $row['INFO4']; ?></H4></a></td>
